...
public:
	...
	//used in GroupBy, generate record, return numAtts
	int ComposeGroup (Record *fromThisSum, Record *fromThisOther, OrderMaker &order);
	...
	void fPrint(Schema *mySchema, FILE * outFile);
};
