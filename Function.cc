    ...
    for (int i = 0; i < numOps; i++) {
            ...
            switch (opList[i].myOp) {
                    case PushInt:
                        cout << "PushInt"; break;
                    case PushDouble:
                        cout << "PushDouble"; break;
                    case ToDouble:
                        cout << "ToDouble";break;
                    case ToDouble2Down:
                        cout << "ToDouble2Down "; break;
                    case IntUnaryMinus:
                        cout << "IntUnaryMinus"; break;
                    case DblUnaryMinus:
                        cout << "DblUnaryMinus"; break;
                    case IntMinus:
                        cout << "IntMinus"; break;
                    case DblMinus:
                        cout << "DblMinus"; break;
                    ...
                    case DblPlus:
                        cout << "DblPlus"; break;
                    case IntDivide:
                        cout << "IntDivide"; break;
                    case DblDivide:
                        cout << "DblDivide"; break;
                    case IntMultiply:
                        cout << "IntMultiply"; break;
                    case DblMultiply:
                        cout << "DblMultiply"; break;
                    default:
                        cout << "UnknownOp"; break;
            }
